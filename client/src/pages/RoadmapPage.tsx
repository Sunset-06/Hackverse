...
import { Topic, Stats, Achievements } from "../types";
...
const userStats: Stats = { progress: 65, streak: 7, timeInvested: 24 };
const achievements: Achievements[] = [
  { name: 'Python Basics', status: 'completed', date: '2024-03-15' },
  { name: 'Data Structures', status: 'completed', date: '2024-03-16' },
  { name: 'Algorithms', status: 'completed', date: '2024-03-17' },
  { name: 'Machine Learning', status: 'completed', date: '2024-03-18' }
];
  ...
  return (
    <div className="w-screen h-screen flex">
      ...
      <div className="w-1/3 fixed top-24 right-0 h-screen pt-8 pr-8"> 
        <Progress stats={userStats} achievements={achievements} />
      </div>
    </div>
  );
};
